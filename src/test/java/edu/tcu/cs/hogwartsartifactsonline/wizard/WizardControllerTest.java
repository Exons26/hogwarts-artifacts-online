...
class WizardControllerTest {
   ...
   MockMvc mockMvc;
    ...
    void testFindAllWizardsSuccess() throws Exception {
        ...
        // When and then
        this.mockMvc.perform(get("/wizards").accept(MediaType.APPLICATION_JSON))
    ...
    void testFindWizardByIdNotFound() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object wizardService.
        given(this.wizardService.findById(5)).willThrow(new WizardNotFoundException("wizard", 5));
    ...
    void testAddWizardSuccess() throws Exception {
        ...
        // When and then
        this.mockMvc.perform(post("/wizards").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateWizardErrorWithNonExistentId() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object wizardService.
        given(this.wizardService.update(eq(5), Mockito.any(Wizard.class))).willThrow(new WizardNot("wizard", 5));
    ...
    void testDeleteWizardErrorWithNonExistentId() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object wizardService.
        doThrow(new edu.tcu.cs.hogwartsartifactsonline.wizard.WizardNotFoundException("wizard", 5)).when(this.wizardService).delete(5);
